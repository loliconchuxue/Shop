...
public class OrderProduct {
	...
	public String toString() {
		return "OrderProduct [orderProductId=" + orderProductId + ", orderId=" + orderId + ", productNumber="
				+ productNumber + ", name=" + name + ", picImg=" + picImg + ", productSpecNumber=" + productSpecNumber
				+ ", productSpecName=" + productSpecName + ", price=" + price + ", score=" + score + ", buyNumber="
				+ buyNumber + ", productScore=" + productScore + ", productAmount=" + productAmount + ", commentStatus="
				+ commentStatus + "]";
	}
