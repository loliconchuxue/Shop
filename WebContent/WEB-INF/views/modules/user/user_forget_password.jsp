    ...
    <div class="reg-box-pan display-inline">
      ...
      <div class="reg-box retrieve-psw" id="verifyCheck" style="margin-top:20px;">
        <div class="part1">
          ...
          <div class="item col-xs-12"> <span class="intelligent-label f-fl"><b class="ftx04">*</b>验证码：</span>
            <div class="f-fl item-ifo">
              ...
              <span class="ie8 icon-close close hide"></span>
              <label class="f-size12 c-999 f-fl f-pl10"> <img src="${ctx}/user/code-image.jpg" id="kaptchaImage" /> </label>
        ...
        <div class="part2" style="display:none">
          ...
          <div class="item col-xs-12" > <span class="intelligent-label f-fl"><b class="ftx04">*</b>验证码：</span>
            <div class="f-fl item-ifo">
              ...
              <span class="btn btn-gray f-r3 f-ml5 f-size13" id="time_box" disabled style="width:97px;display:none;">发送验证码</span> <span class="btn btn-gray f-r3 f-ml5 f-size13" id="verifyYz" data-type="/user/sendEmailRegister" style="width:97px;" data-emailSign="">发送验证码</span> <span class="ie8 icon-close close hide" style="right:130px"></span>
              <label class="icon-sucessfill blank hide"></label>
        ...
        <div class="part4 text-center" style="display:none">
          <h3></h3>
          <p class="c-666 f-mt30 f-mb50">页面将在 <strong id="times" class="f-size18">10</strong> 秒钟后，跳转到 <a href="${ctx}/user/login" class="c-blue">登陆界面</a></p>
        </div>
