        ...
        <div class="part1">
          <form method="post" id="verifyUser">
            ...
            <div class="item col-xs-12"> <span class="intelligent-label f-fl"><b class="ftx04">*</b>电子邮箱：</span>
              <div class="f-fl item-ifo">
                <input type="text" name="email" class="txt03 f-r3 required btn_part3" keycodes="email" tabindex="2" data-valid="isNonEmpty||isEmail" data-error="电子邮箱不能为空||电子邮箱格式不正确" maxlength="20" id="email" />
                <span class="ie8 icon-close close hide"></span>
                <label class="icon-sucessfill blank hide"></label>
