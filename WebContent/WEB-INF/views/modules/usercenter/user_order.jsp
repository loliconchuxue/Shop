      ...
      <div class="box-hd">
        ...
        <div class="more clearfix">
          <ul class="filter-list J_orderType">
            ...
            <li class="${type eq 3 ? 'active':''}"><a href="${ctx}/uc/order/list?type=3" data-type="3">已完成</a></li>
            <li class="${type eq 4 ? 'active':''}"><a id="J_sendTab" href="${ctx}/uc/order/list?type=4" data-type="2">已关闭</a></li>
          </ul>
            ...
            <c:forEach items="${orderVOs}" var="orderVO">
                      ...
                      <thead>
                        <tr>
                          <th class="col-main"> <p class="caption-info">
                              ...
                              <span class="sep">|</span>订单号： <a href="${ctx}/uc/order/${orderVO.orderNumber}">${orderVO.orderNumber}</a><span class="sep">|</span>在线支付</p>
                          </th>
              ...
              <c:if test="${orderVO.orderStatus eq 3}">
                <li class="uc-order-item uc-order-item-shipping">
                  <div class="order-detail">
                    <div class="order-summary">
                      <div class="order-status">待揽件</div>
                      <p class="order-desc J_deliverDesc"> 我们将尽快为您发货 </p>
                    </div>
                    <table class="order-detail-table">
                      <thead>
              ...
              <c:if test="${orderVO.orderStatus eq 4}">
                <li class="uc-order-item uc-order-item-shipping">
                  <div class="order-detail">
                    <div class="order-summary">
                      <div class="order-status">运输中</div>
                      <p class="order-desc J_deliverDesc"> 我们将尽快为您发货 </p>
                    </div>
                    <table class="order-detail-table">
                      <thead>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="order-actions"><a class="btn btn-small btn-primary" href="${ctx}/buy/takedelivery/${orderVO.orderNumber}" target="_blank">收货</a> <a class="btn btn-small btn-line-gray" href="${ctx}/uc/order/${orderVO.orderNumber}">订单详情</a></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
